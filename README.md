...
To build the final jar and optimize the TransactionsAsyncSvc application for production, run:
...
Then navigate to [http://localhost:9095](http://localhost:9095) in your browser.
